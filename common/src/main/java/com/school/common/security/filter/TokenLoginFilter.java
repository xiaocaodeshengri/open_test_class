package com.school.common.security.filter;


import com.fasterxml.jackson.databind.ObjectMapper;
import com.school.common.response.R;
import com.school.common.response.ResponseUtil;
...
public class TokenLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain,
        ...
        ResponseUtil.out(res, R.ok().data("token", token).data("name",user.getCurrentUserInfo().getUsername()));
    }
